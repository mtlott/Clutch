...
[ ! -f /config/clutch.debug.log ] || mv /config/clutch.debug.log /config/log/clutch.debug.log

# Clear the fstab file to make sure its content is not displayed in Clutch
